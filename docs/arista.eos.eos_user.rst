                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>The set of username objects to be configured on the remote Arista EOS device.  The list entries can either be the username or a hash of username and properties.  This argument is mutually exclusive with the <code>username</code> argument.</div>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>Instructs the module to consider the resource definition absolute.  It will remove any previously configured usernames on the device with the exception of the `admin` user which cannot be deleted per EOS constraints.</div>
                                                        </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                            ...
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;name ansible secret password&#x27;, &#x27;name admin secret admin&#x27;]</div>
                                    </td>
            </tr>
                                <tr>
                                <td colspan="1">

                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                ...
                                                <td>
                                            <div>List of allowed VLANs in a given trunk port. If <code>mode=trunk</code>, these are the ONLY VLANs that will be configured on the trunk, i.e. <code>2-10,15</code>.</div>
                                                                <div style="font-size: small; color: darkgreen"><br/>aliases: trunk_vlans</div>
                                    </td>
            </tr>
                        </table>
    <br/>
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                            ...
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;interface ethernet1&#x27;, &#x27;switchport access vlan 20&#x27;]</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
